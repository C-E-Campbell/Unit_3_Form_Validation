...
<hr>
<br>
<p>This project is a basic form with different validation fields. All values are tested against reg expressions and all values must be valid before the form can be submitted. All Js is written in jQuery to show I know the library - Can be done in vanilla js just as easily!</p><br>
<h3>Features</h3>
